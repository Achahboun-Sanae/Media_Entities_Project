...
BASE_URL = "https://www.akhbarona.com/page/"

def scrape_akhbarona(pages=200):  # Scraper un nombre élevé de pages pour atteindre 5000 articles
    extracted_data = []
...
if __name__ == "__main__":
    articles = scrape_akhbarona(pages=200)  # Scraper 200 pages pour atteindre environ 5000 articles
